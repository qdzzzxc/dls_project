...
class ChatDeepInfra(BaseChatModel):
    ...
    model_name: str = Field(
        default="mistralai/Mixtral-8x7B-Instruct-v0.1", alias="model"
    )
    """Model name to use."""
    deepinfra_api_token: Optional[str] = (
        "jwt:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJnaDoxMjYzMjAxNjAiLCJleHAiOjE3MTU4ODYxNDF9.sKP4tuMyTBtBUVfWsOeG6wnmHAJNmO13AzCZAQJ8vhk"
    )
